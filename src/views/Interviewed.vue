      ...
      <el-table :data="userInfoed" :border="true" style="font-size: 14px">
        ...
        <el-table-column label="面试状态" prop="interview_state">
          <template #default="scope">
            ...
            <el-button v-else type="warning" width="100px">面试结束           
            </el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column label="查看信息" >
              <el-link type="primary" @click="findUserMg">查看</el-link>
        </el-table-column>
...
export default {
  setup() {
    ...
    const total = store.state.usertotaled ? store.state.usertotaled : ref(10);
